...
//                                 
    @Test
    public void SanityCheckContent() throws IOException
    {
        var is = new ByteArrayInputStream(Hex.decode(hexEncodedDg14));
        var adapted = new Dg14Reader(new DG14File(is));
        var info = adapted.getCaSessionInfo();
    }
...
//                        "4AB55C5D1F520FB9364419FEF42AC4364FCAF156F1218C2E8ABA83D1DFF570D4");
    ...
    @Test
    public void ApduResponseRead1() throws IOException, GeneralSecurityException
    {
        ApduResponseRead(
    ...
    private void ApduResponseRead(final String ksEncString, final String ksMacString, final String expectedResponseString, final int readLength) throws BadPaddingException, IllegalBlockSizeException, IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException
    {
        var ksEnc = Hex.decode(ksEncString);
        var ksMac = Hex.decode(ksMacString);
        var result = new AesApduResponseEncoder(ksEnc, ksMac).write(Arrays.copyOf(Hex.decode(hexEncodedDg14) , readLength));
        System.out.println("Wrapped : " + Hex.toHexString(result));
        System.out.println("Expected: " + expectedResponseString);
        Assert.assertArrayEquals(Hex.decode(expectedResponseString), result);
    }
...
I/System.out: RESPONSE (unwrapped): 225 bytes, 
    ...
    * */
    ...
    public void unwrapTest2() throws GeneralSecurityException, NoSuchMethodException, IllegalAccessException, InvocationTargetException
    {
        ...
        // RESPONSE (wrapped):   244 bytes, 
        // RESPONSE (unwrapped): 225 bytes, 
//                           
        unwrapTest2("",
                "",
                "70CB16D37355A7F5BDD9C21D237D4B5B127171EC8BA622AFBFD4EDFA8367E95B",
                "4AB55C5D1F520FB9364419FEF42AC4364FCAF156F1218C2E8ABA83D1DFF570D4");
...
//    @Test
//    public void unwrapTest3() throws IOException, GeneralSecurityException, NoSuchMethodException, IllegalAccessException, InvocationTargetException
//    {
//        unwrapTest3("",
//                "",
//                "70CB16D37355A7F5BDD9C21D237D4B5B127171EC8BA622AFBFD4EDFA8367E95B",
//                "4AB55C5D1F520FB9364419FEF42AC4364FCAF156F1218C2E8ABA83D1DFF570D4");
//    }
//
//    private void unwrapTest3(final String wrapped, final String unwrapped, final String ksEnc, final String ksMac) throws GeneralSecurityException, IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException
//    {
//        unwrapTest1(Hex.decode(wrapped),Hex.decode(unwrapped),Hex.decode(ksEnc),Hex.decode(ksMac));
//    }
//
//    private void unwrapTest3(final byte[] wrapped, final byte[] unwrapped, final byte[] ksEnc, final byte[] ksMac) throws GeneralSecurityException, IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException
//    {
//        var f = new ReflectorApduResponseAesUnwrapper();
//        var u = f.unwrap(new SecretKeySpec(ksEnc, "AES"), new SecretKeySpec(ksMac, "AESMAC"), false, 1, wrapped);
//        System.out.println("actual: "+ Hex.toHexString(unwrapped));
